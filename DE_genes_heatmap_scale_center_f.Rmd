...
* 
=======
>>>>>>> 4a0b970bd523cd086f5d8a2f7b8ca91641022bf2
...
#import data
```{r}
Col.1h <- read.csv("../output/DEGs_with_description/DEgenes.Col.1h.rH.csv")
Col.49h <- read.csv("../output/DEGs_with_description/DEgenes.Col.49h.rH.csv")
myc234.1h <- read.csv("../output/DEGs_with_description/DEgenes.myc234.1h.rH.csv")
myc234.49h <- read.csv("../output/DEGs_with_description/DEgenes.myc234.49h.rH.csv")
myc234.1h.rCol <- read.csv("../output/DEGs_with_description/DEgenes.myc234.1h.rCol.rH.csv")
myc234.49h.rCol <- read.csv("../output/DEGs_with_description/DEgenes.myc234.49h.rCol.rH.csv")
...
plotly_IMAGE(final.plot2, width = 1000, height = 500, format = "jpeg", scale = 2,
             out_file = "../output/figures_and_tables/DEgenes.heatmap.final.version.scale.false.jpeg")
