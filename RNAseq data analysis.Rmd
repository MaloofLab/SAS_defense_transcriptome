...
#design 1h
```{r}
design.1h <- model.matrix(~gt*trt,data = sample.description.1h)
...
myc234.1h.lrt <- glmLRT(fit.1h,coef =6)
...
```{r}
plotDE(rownames(DEgene.myc234.1h),dge.data.1h,sample.description.1h)
```