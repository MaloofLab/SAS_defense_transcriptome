...
# Can you add processes from fastq (quality check by fastqc), trimming, and mapping to reference cDNA? (Kazu)
...
for i in $sample
do echo $i
kallisto quant -i --fr-stranded arabidopsis_cdna.idx -o ~/RNAseq/map_output2/${i}_output --single --plaintext -l 300 -s 100 ${i}
done
