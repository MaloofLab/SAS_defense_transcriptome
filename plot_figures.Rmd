...
```{r}
#
list.files(path=file.path("..","output","figures_and_tables"), pattern = ".rH\\.csv")
#only retain the Col and myc234 data
DEG.objs2 <- list.files(path=file.path("..","output","figures_and_tables"), pattern = ".rH\\.csv")[1:6]
DEG.objs2
```
...
DEG.list<-lapply(DEG.objs2, function(x) read_csv(paste(file.path("..","output","figures_and_tables"),"/",x,sep="")))
